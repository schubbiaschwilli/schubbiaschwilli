...
def BSMLongCondorSpread(S, T, r, sigma, Greek):         
    LongCall1 = BSMOption("Call", S, T, S_0*0.8, r, sigma, Greek)
    ShortCall1 = BSMOption("Call", S, T, S_0*0.9, r, sigma, Greek)
    ShortCall2 = BSMOption("Call", S, T, S_0*1.1, r, sigma, Greek)
    LongCall2 = BSMOption("Call", S, T, S_0*1.2, r, sigma, Greek)

    return (LongCall1 - ShortCall1 - ShortCall2 + LongCall2)
...
for j in range(0, Npaths):
   ...
   # DeltaHedge
   V = BSMLongCondorSpread(S, T, r, sigma, "Price")  # initial investment
   a = BSMLongCondorSpread(S, T, r, sigma, "Delta") # stock position<-delta
   ...
   for i in range(0, Nhedgepoints+1):
      ...
      a = BSMLongCondorSpread(S, T-i*dt, r, sigma, "Delta")
      b = V-a*S
   
   S_t[j] = S
   Hedge[j] = V
   Payoff[j] = BSMLongCondorSpread(S, 0, r, sigma, "Price")
